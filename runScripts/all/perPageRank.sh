...
do
    OUTPUT_FILE_PATH=/home/bongki/Dropbox/ExperimentData/PersonalizedPageRank/Parallel/NO_Partition/LiveJournal/Thread${thr}/Values
    ...
    do
        ...
        java -server -Xms16g -Xmx16g -da -XX:BiasedLockingStartupDelay=0 -XX:MaxInlineSize=256 -XX:FreqInlineSize=256 -jar ${PROJECT_DIR}/jar/${PROGRAM} ${GRAPH_FILE} ${thr} ${threshold} ${EXP_OF_PARTITION_SIZE} ${SEED_FILE} ${NUM_SEED} ${OUTPUT_ASYNC_FILE} ${ITER}
    done
done
