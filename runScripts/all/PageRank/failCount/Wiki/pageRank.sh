...
do
    ...
    OUTPUT_FILE_PATH=/home/bongki/Dropbox/ExperimentData/PageRank/Parallel/NO_Partition/Wiki18M/Thread${thr}/failCounts
    ...
    #| awk -F ' ' ' { print $2 } ' 1>> ${OUTPUT_ATOMIC_FILE}

    for threshold in 16 32 64 128 256 512 1024 2048 4096 8192 16384 32768 65536 131072
    do
