...
//    Task[] barrierTasks;
//
//    BTCExecutor[] btcExecutors;
//
//    public BTCSequentialDriver(Graph<SSSPSharedData> graph, int numThreads, int delta, int source) {
//        this.graph = graph;
...
//        btcExecutors = new BTCExecutor[numTasks];
...
//            }
//            btcExecutors[i] = new BTCExecutor(beginRange, endRange, graph, delta, numCheck);
//            workTasks[i] = new Task(btcExecutors[i]);
//        }
//
